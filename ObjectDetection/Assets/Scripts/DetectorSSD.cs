...
public class Detectorssd2 : MonoBehaviour, Detector
{
    ...
    private IList<BoundingBox> ParseOutputs(Tensor ssdModelOutput, float threshold)
    {
        ...
        for (int cy = 0; cy < COL_COUNT; cy++)
        {
            for (int cx = 0; cx < ROW_COUNT; cx++)
            {
                for (int box = 0; box < BOXES_PER_CELL; box++)
                {
                    ...
                    var bbd = ExtractBoundingBoxDimensions(ssdModelOutput, cx, cy, channel);
                    float confidence = GetConfidence(ssdModelOutput, cx, cy, channel);
                    ...
                    float[] predictedClasses = ExtractClasses(ssdModelOutput, cx, cy, channel);
...
public class Detectorssd2 : MonoBehaviour, Detector
{
    ...
    private float[] anchors = new float[]
    {
        // 1.08F, 1.19F, 3.42F, 4.41F, 6.63F, 11.38F, 9.42F, 5.11F, 16.62F, 10.52F  // ssdv2-tiny-voc
        //0.57273F, 0.677385F, 1.87446F, 2.06253F, 3.33843F, 5.47434F, 7.88282F, 3.52778F, 9.77052F, 9.16828F // ssdv2-tiny
        0.57273F, 0.677385F, 1.87446F, 2.06253F, 3.33843F, 5.47434F, 7.88282F, 3.52778F, 9.77052F, 9.16828F  // ssdv2-tiny-food
    };
